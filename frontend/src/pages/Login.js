                ...
                <div className='bg-white p-5 w-full max-w-sm mx-auto'>
                    ...
                    <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <Link to={'/forgot-password'} className='block w-fit ml-auto hover:underline hover:text-green-600'>Forgot Password ?</Link>
                        </div>
                        <button className='hover:bg-green-700 bg-green-600 text-white px-6 py-2 w-full max-w-[150px] rounded-full hover:scale-110 transition-all mx-auto block mt-6'>Login</button>
                    </form>
                    <p className='my-5'>Don't have account ? <Link className='text-green-600 hover:underline hover:text-green-700' to={'/sign-up'}>Sign up</Link> </p>
                </div>
            </div>
        </section>
    )
